...
class Questions{
    ...
    void instructions(){
        System.out.print("Note:\tTotal 10 MCQs will be shown. First read carefully the questions\n\t\tthen pick an answer key(i.e. a,b,c or d) and put in the input as per regarding question.\n\t\tPress enter to  continue: ");
    }
    void runProgram(){
    ...
    void userAnswer(){
        if (qNo<=que.length) {
            ...
            do {
                ...
                Scanner sc = new Scanner(System.in);
                System.out.print("Your answer for Q" + qNo + ": ");
    ...
    void checkAnswers(char ans){
        if (ans == cOpt[i]) {
            ...
            System.out.println("Wrong option, correct option is " + cOpt[i]);
        }
        i += 1;
    }
    void marks(){
        System.out.println("\nYou scored "+score+" marks out of 10.");
